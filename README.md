...
- **Verified answers.** Calculations run in a code sandbox, and a second model solves the question independently. Matching results are marked _Verified_; differing results are flagged for review.
...
3. **Independent check.** A model from a different family solves the question from scratch and compares final answers.
